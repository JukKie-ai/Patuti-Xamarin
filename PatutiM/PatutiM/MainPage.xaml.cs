...
namespace PatutiM
{
    public partial class MainPage : ContentPage
    {
        ...
        int boxX = 0, boxY = 0, patutiX = 0, patutiY = 0, targetX = 0, targetY = 0, direction = 0, health = 5;
        bool reset = true;
        bool [,]mat = new bool[,]{
        ...
        private async void canvasView_PaintSurface(object sender, SKPaintSurfaceEventArgs e)
        {
            ...
            else
            {
                ...
                if (tocheck && patutiY>1) {
                    //System.Diagnostics.Debug.WriteLine(patutiY);
                    //System.Diagnostics.Debug.WriteLine(patutiX);
                    ...
                    if (health == 0) {
                        var message = await this.DisplayAlert("You Died", "Dead Patuti", "Try Again", "Cancel");
                    ...
                    if(patutiX == 360 && patutiY == 600 && reset) {

                        reset = false;
                        var result = await this.DisplayAlert("You Win", "Win Patuti", "OK", "Cancel");
